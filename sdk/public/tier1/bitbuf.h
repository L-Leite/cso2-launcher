...
public:
    ...
    void WriteUBitLong( unsigned int data, int numbits,
                                            ...
                                            bool bCheckRange )
{
    ...
    curData =
        ( curData << iCurBitMasked ) | ( curData >> ( 32 - iCurBitMasked ) );
...
inline int bf_read::ReadOneBitNoCheck()
{
    ...
    unsigned int value = ( (unsigned long* RESTRICT)m_pData )[m_iCurBit >> 5] >>
                         ( m_iCurBit & 31 );
#else
