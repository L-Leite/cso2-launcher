...
// __GNUC__ has the align decoration at the end
#define ALIGN4
#define ALIGN8 
#define ALIGN16
#define ALIGN32
...
//-----------------------------------------------------------------------------
#if defined( __GNUC__ ) && !defined( COMPILER_MINGW )
...
#elif defined(__GNUC__) && !defined( COMPILER_MINGW )
...
#if defined( LINUX ) && ((__GNUC__ * 100) + ____GNUC___MINOR__) >= 406
...
inline uint64 Plat_Rdtsc()
{
...
#elif defined( _WIN32 ) && !defined( COMPILER_MINGW )
	...
	__asm ret;
  #endif
#elif defined( __i386__ ) || defined( COMPILER_MINGW )
    uint64 val;
	__asm__ __volatile__ ( "rdtsc" : "=A" (val) );
	return val;
#elif defined( __x86_64__ ) || defined( COMPILER_MINGW64 )
	uint32 lo, hi;
...
// CSO2
PLATFORM_INTERFACE const char* Plat_CSO2BuildVersion();																		
