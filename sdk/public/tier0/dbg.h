...
/*DBG_INTERFACE*/ inline bool HushAsserts() { return false; }
...
inline void DevMsg( PRINTF_FORMAT_STRING const tchar* pMsg, ... ) FMTFUNCTION( 1, 2 )
{ 
	va_list args;
	va_start( args, pMsg );
	DevMsg(1, pMsg, args);
...
inline void DevWarning( PRINTF_FORMAT_STRING const tchar *pMsg, ... ) FMTFUNCTION( 1, 2 )
{ 
	va_list args;
	va_start( args, pMsg );
	DevWarning(1, pMsg, args);
	va_end(args);
}

inline void DevLog( PRINTF_FORMAT_STRING const tchar *pMsg, ... ) FMTFUNCTION( 1, 2 )
{ 
	va_list args;
	va_start( args, pMsg );
	DevLog(1, pMsg, args);
...
inline void ConColorMsg( const Color& clr, PRINTF_FORMAT_STRING const tchar* pMsg, ... ) FMTFUNCTION( 2, 3 )
{ 
	va_list args;
	va_start( args, pMsg );
	ConColorMsg(1, clr, pMsg, args);
	va_end(args);
}

inline void ConMsg( PRINTF_FORMAT_STRING const tchar* pMsg, ... ) FMTFUNCTION( 1, 2 )
{ 
	va_list args;
	va_start( args, pMsg );
	ConMsg(1, pMsg, args);
...
inline void ConWarning( PRINTF_FORMAT_STRING const tchar *pMsg, ... ) FMTFUNCTION( 1, 2 )
{ 
	va_list args;
	va_start( args, pMsg );
	ConWarning(1, pMsg, args);
	va_end(args);
}

inline void ConLog( PRINTF_FORMAT_STRING const tchar *pMsg, ... ) FMTFUNCTION( 1, 2 )
{ 
	va_list args;
	va_start( args, pMsg );
	ConLog(1, pMsg, args);
...
DBG_INTERFACE void COM_WriteReportLog( int level, PRINTF_FORMAT_STRING char const *fmt, ... ) FMTFUNCTION( 1, 2 ); // level is unused
DBG_INTERFACE void COM_WriteReportLogW( int level, PRINTF_FORMAT_STRING wchar_t const *fmt, ... ) FMTFUNCTION( 1, 2 ); // level is unused
