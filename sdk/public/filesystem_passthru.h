...
public:
	...
	virtual int				BaseFileSystem00( int a1, int a2, int a3, int a4 ) { return m_pBaseFileSystemPassThru->BaseFileSystem00( a1, a2, a3, a4 ); }
	virtual bool			BaseFileSystem01( int a1, int a2, int a3, int a4, int a5, int a6 ) { return m_pBaseFileSystemPassThru->BaseFileSystem01( a1, a2, a3, a4, a5, a6 ); }
	virtual int				BaseFileSystem02( int a1, int a2 ) { return m_pBaseFileSystemPassThru->BaseFileSystem02( a1, a2 ); }
	virtual int				BaseFileSystem03( int a1 ) { return m_pBaseFileSystemPassThru->BaseFileSystem03( a1 ); }
	virtual CSO2FileSystem*	GetCSO2FileSystem() { return m_pBaseFileSystemPassThru->GetCSO2FileSystem(); }
	virtual bool			BaseFileSystem04( int a1, int a2 ) { return m_pBaseFileSystemPassThru->BaseFileSystem04( a1, a2 ); }
protected:
...
public:
	...
	virtual bool			FullPathToRelativePathEx( const char *pFullPath, int a2, const char *pPathId, OUT_Z_CAP( maxLenInChars ) char *pDest, int maxLenInChars ) { return m_pFileSystemPassThru->FullPathToRelativePathEx( pFullPath, a2, pPathId, pDest, maxLenInChars ); }
	...
	virtual bool			AddPackFile( const char *fullpath, const char *pathID )								{ return false; /*m_pFileSystemPassThru->AddPackFile( fullpath, pathID );*/ }
	...
	virtual bool			FileSystem00() { return m_pFileSystemPassThru->FileSystem00(); }
	virtual void			FileSystem01() { m_pFileSystemPassThru->FileSystem01(); }
	virtual int				FileSystem02( int a1, int a2, int a3, int a4 ) { return m_pFileSystemPassThru->FileSystem02( a1, a2, a3, a4 ); }
	virtual int				FileSystem03( void* a1 ) { return m_pFileSystemPassThru->FileSystem03( a1 ); }
	virtual int				FileSystem04( void* a1 ) { return m_pFileSystemPassThru->FileSystem04( a1 ); }
	virtual void			FileSystem05() { m_pFileSystemPassThru->FileSystem05(); }

	virtual bool			FileSystem38( char* a2 ) { return m_pFileSystemPassThru->FileSystem38( a2 ); }

	virtual void			FileSystem101( char *a2, int a3, int a4 ) { m_pFileSystemPassThru->FileSystem101( a2, a3, a4 ); }
	virtual void			FileSystem102( int a2, int a3, int a4 ) { m_pFileSystemPassThru->FileSystem102( a2, a3, a4 ); }
	virtual void			FileSystem103( char *a2, int a3, int a4 ) { m_pFileSystemPassThru->FileSystem103( a2, a3, a4 ); }

	virtual const char* GetGameDirectoryName() { return m_pFileSystemPassThru->GetGameDirectoryName(); }
	virtual const char* GetGameDirectoryNameAgain() { return m_pFileSystemPassThru->GetGameDirectoryNameAgain(); }

	virtual void* CallSomethingInMainThread( int a2, void* a3 ) { return m_pFileSystemPassThru->CallSomethingInMainThread( a2, a3 ); }
	virtual void* CallSomething( int a2, void* a3 ) { return m_pFileSystemPassThru->CallSomething( a2, a3 ); }
