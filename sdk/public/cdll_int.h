...
public:
	...
	virtual void				ServerCmd( bool a2, const char *szCmdString, bool bReliable = true ) = 0;
	...
	// From CSO2
	virtual const ModelEntry_t*	FindModelEntry( FileNameHandle_t& hModelFile ) = 0;		   
	virtual FileNameHandle_t	GetFileNameHandleByIndex( unsigned short iIndex ) = 0;
	...
	virtual void		SetMapLoadingProgress( CSO2MapLoadingProgress_t iMapLoadProgress, int iLoadPercentage, int a3 ) = 0;
	...
	virtual	int				SetLobbyMusic( const char* szMusicPath ) = 0; // maybe, maybe not; untested
	...
	virtual bool FileSystem158( int a1, int a2, int a3, int a4 ) = 0; // returns false
	...
	virtual void				FileSystem165( void* a2 ) = 0; // calls something from CCSO2CacheMgr
