...
bool Load( unsigned char* imageData, const char* fileName, int width,
           int height, enum ImageFormat imageFormat, float targetGamma,
           bool mipmap );
...
{
    ResampleInfo_t()
        : m_nFlags( 0 ), m_flAlphaThreshhold( 0.4f ),
...
void GenerateMipmapLevelsLQ( unsigned char* pSrc, unsigned char* pDst,
