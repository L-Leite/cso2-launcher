...
public:
	...
	virtual bool		FullPathToRelativePathEx( const char *pFullpath, int a2 /*set to zero*/, const char *pPathId, OUT_Z_CAP( maxLenInChars ) char *pDest, int maxLenInChars ) = 0;
	...
	{
		return FullPathToRelativePathEx( pFullpath, 0, pDest, (int) maxLenInChars );
	}

	// Gets the current working directory
	virtual bool			GetCurrentDirectory( char* pDirectory, int maxlen ) = 0;
	virtual bool			FileSystem38( char* a2 ) = 0; // i have a feeling this is directory related
	...
	virtual DVDMode_t	GetDVDMode() = 0; // DIDNT REVERSE BELLOW SINCE IDC ABOUT THIS STUFF RN
