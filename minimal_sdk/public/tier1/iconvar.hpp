...
#define FCVAR_CHEAT \
    ( 1 << 14 )  // Only useable in singleplayer / debug / multiplayer &
                 // sv_cheats
...
#define FCVAR_REPLICATED \
    ( 1 << 13 )  // server setting enforced on clients, TODO rename to
                 // FCAR_SERVER at some time
...
#define FCVAR_CLIENTCMD_CAN_EXECUTE \
    ( 1 << 30 )  // IVEngineClient::ClientCmd is allowed to execute this
                 // command. Note: IVEngineClient::ClientCmd_Unrestricted can
                 // run any client command.
...
constexpr const char* CVAR_QUERY_INTERFACE_VERSION = "VCvarQuery001";
