...
constexpr const char* MDLCACHE_INTERFACE_VERSION = "MDLCache004";
...
public:
    ...
    virtual int GetAutoplayList( MDLHandle_t handle,
                                 unsigned short** pOut ) = 0;
    ...
    virtual bool IsDataLoaded( MDLHandle_t handle,
                               MDLCacheDataType_t type ) = 0;
