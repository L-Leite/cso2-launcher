...
constexpr const char* VGUI_SURFACE_INTERFACE_VERSION = "VGUI_Surface030";
...
public:
    ...
    virtual void DrawSetTextureRGBA( int id, const unsigned char* rgba,
    ...
    virtual void CreatePopup( VPANEL panel, bool minimised,
                              ...
                              bool disabled = false, bool mouseInput = true,
                              bool kbInput = true ) = 0;
    ...
    virtual void GetCharABCwide( HFont font, int ch, int& a, int& b,
                                 int& c ) = 0;
    ...
    virtual void DrawOutlinedCircle( int x, int y, int radius,
                                     int segments ) = 0;
    ...
    virtual vgui::HCursor CreateCursorFromFile( const char* curOrAniFile,
